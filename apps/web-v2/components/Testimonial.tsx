...
const testimonials = [
  ...
  },
  {
    id: 2,
    quote:
      "I made a soap with the help of AI, it was so easy to use. Truly remarkable how intuitive the entire process was.",
    name: "Tyler Durden",
  ...
  },
  {
    id: 4,
    quote:
      "The depth of understanding this AI demonstrates is simply astonishing. Every interaction feels purposeful and precise.",
    name: "Marco Rivera",
    title: "Product Lead",
    avatar: "MR",
    color: "#f59e0b",
  },
  {
    id: 5,
    quote:
      "I've tried dozens of AI tools. None come close to this level of sophistication. It's not just smart — it's wise.",
    name: "Priya Nair",
...
const testimonials2 = [
  {
    id: 6,
    quote:
      "Absolutely revolutionary, a game-changer for our industry. We've cut delivery time by 40% since adopting it.",
    name: "Bob Smith",
  ...
  },
  {
    id: 7,
    quote:
      "I can't imagine going back to how things were before this AI. It's become the backbone of our entire workflow.",
    name: "Cathy Lee",
  ...
  },
  {
    id: 9,
    quote:
      "Seamlessly integrates into everything we do. The ROI within the first month alone was enough to justify the switch.",
    name: "Sofia Mendez",
  ...
  },
  {
    id: 10,
    quote:
      "Our clients noticed the difference immediately. Quality went up, turnaround went down. That's all we ever wanted.",
    name: "James Park",
...
const testimonials3 = [
  ...
  },
  {
    id: 14,
    quote:
      "The suggestions it gives are eerily accurate. It's like it reads the room — every time, without fail.",
    name: "Lena Torres",
    title: "UX Researcher",
    avatar: "LT",
    color: "#6366f1",
  },
  {
    id: 15,
    quote:
      "Adopting this AI was the single best strategic decision our team made this year. Results speak louder than words.",
    name: "Omar Hassan",
...
const testimonials4 = [
  ...
  },
  {
    id: 19,
    quote:
      "Every department has benefited. From design to analytics, it accelerates everything it touches.",
    name: "Nina Watts",
  ...
  },
  {
    id: 20,
    quote:
      "I was skeptical at first. Now I genuinely can't imagine our process without it. Total convert.",
    name: "Carlos Reyes",
...
function ScrollColumn({ items, direction, speed = 0.4 }: ScrollColumnProps) {
        ...
        >
          ...
          <div
            style={{
              ...
              height: "120px",
              background:
                "linear-gradient(to bottom, #080a0f 0%, transparent 100%)",
              zIndex: 10,
              pointerEvents: "none",
            }}
          />
          ...
          <div
            style={{
              ...
              height: "120px",
              background:
                "linear-gradient(to top, #080a0f 0%, transparent 100%)",
              zIndex: 10,
              pointerEvents: "none",
            }}
          />
          ...
          >
            <ScrollColumn items={testimonials} direction="up" speed={0.35} />
            <ScrollColumn items={testimonials2} direction="down" speed={0.45} />
            <ScrollColumn items={testimonials3} direction="up" speed={0.38} />
            <ScrollColumn items={testimonials4} direction="down" speed={0.42} />
          </div>
        </div>
